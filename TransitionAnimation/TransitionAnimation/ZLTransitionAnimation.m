...
- (void)doPushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    ZLTableViewController *fromVC = (ZLTableViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ZLTransitionViewController *toVC = (ZLTransitionViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //拿到当前点击的cell的imageView
    ZLCollectionViewCell *cell = (ZLCollectionViewCell *)[fromVC.collectionView cellForItemAtIndexPath:fromVC.currentIndexPath];
...
- (void)doPopAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ZLTransitionViewController *fromVC = (ZLTransitionViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ZLTableViewController *toVC = (ZLTableViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    ZLCollectionViewCell *cell = (ZLCollectionViewCell *)[toVC.collectionView cellForItemAtIndexPath:toVC.currentIndexPath];
    UIView *containerView = [transitionContext containerView];
